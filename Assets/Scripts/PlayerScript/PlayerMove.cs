...
public class PlayerMove : MonoBehaviour
{
    ...
    void Deplacements()
    {       
        //recupere l'entr�e horizontale (float allant de -1 � 1)
        ...
        // D�terminer la position de d�part du raycast
        ...
        // Dessiner le Raycast dans la sc�ne
    ...
    void Jump()
    {
        ...
        {
            // Applique une force de saut sur le corps rigide en fonction de la dur�e du saut
